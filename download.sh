...
#OLDBASEDIR=/nv/pc5/vhe/VERITAS/raw_data
#OLDBASEDIR=/gpfs/pace1/project/phy-otte/vhe/VERITAS/raw_data/
#OLDBASEDIR=/gpfs/pace1/project/phy-otte/vhe/VERITAS/raw_data/
#BASEDIR=/gpfs/pace1/project/phy-otte/VERITAS/raw_data
#OLDBASEDIR=/gpfs/pace2/project/pc5/vhe/VERITAS/raw_data
OLDBASEDIR=/storage/coda1/p-aotte6/0/shared/rich_project_pc5/vhe/VERITAS/raw_data
#BASEDIR=/storage/coda1/p-aotte6/0/shared/VERITAS/raw_data
BASEDIR=/storage/scratch1/7/agent3

UCLAHOST=gamma1.astro.ucla.edu
#UCLAHOST=veritas.chpc.utah.edu
...
for ((i=0;i<${#FILES[@]};i++)); do
 ...
 if [ "${GROUPID}" = "-1" ]
     then
     echo "Oops, no group specified for run ${RUN} in the database"
     LASERRUN=""
 else 
...
#      fi
 ...
 #     FINALDIRTRUE=/data_disks/${DISK}/data/raw/${DAY}
      OLDFINALDIRTRUE=${OLDBASEDIR}/${DAY}
      FINALDIRTRUE=${BASEDIR}/${DAY}
      mkdir -p ${FINALDIRTRUE}
      mkdir -p ${OLDFINALDIRTRUE}
      ...
      ln -s ${FINALDIRTRUE}/${FILEUCLA} ${OLDFINALDIRTRUE}/${FILEUCLA}
    ...
    mkdir ${OLDFINALDIRTRUE}
    chmod ug+w ${OLDFINALDIRTRUE}
    ln -s ${FINALDIRTRUE}/${RUN}.${SOURCE}.cvbf ${OLDFINALDIRTRUE}/${RUN}.${SOURCE}.cvbf
	...
	#    fi
	 ...
	 #   echo "Laserrun ${LASERRUN} will go to disk ${DISK}"
	  ...
	  #  FINALDIRTRUE=/data_disks/${DISK}/data/raw/${DAY}
	    ...
	    chmod ug+w ${OLDFINALDIRTRUE}/.
	    chmod ug+w ${OLDFINALDIRTRUE}
            ln -s ${FINALDIRTRUE}/${LASERRUN}.laser.cvbf ${OLDFINALDIRTRUE}/${LASERRUN}.laser.cvbf           
